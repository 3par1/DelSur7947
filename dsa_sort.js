...
function ts_sort_caseinsensitive(a, b) {
   ...
   //yusuxu@cn.ibm.com -- DSA is showing Windows Log in alphabetical order -- 1. Error Events 2. Information Events 3. Warning Events
	//Christian Flatscher/UK/IBM need DSA to show in priority order -- 1. Error Events 2. Warning Events 3. Information Events
   if ((aa == "error") && (bb == "warn"))
	returnValue = -1;
   if ((aa == "warn") && (bb == "error"))
       returnValue = 1;
   ...
   if ((aa == "warn") && (bb == "info"))
	returnValue = -1;
   // yusuxu@cn.ibm.com --end of code update
